...
line_bot_api = LineBotApi(
    '9+lsi9ssuaA11KmxI4TBGHXopJkMFCZ+C53lm8BFou2yWrhhIOj8/B/tGLUgHoXIrBlZfIn86trOcpmR4Ac42Azwt/D569RCk8wbnIJMiQSqwZkPfDxT05JEnNu2VkZxMwXvKtDiPhQajE8rhyJt+AdB04t89/1O/w1cDnyilFU=')
# Channel Secret
...
def handle_message(event):
    print(event.reply_token)
    print(event.message)
    # action 點擊動作 pixel位置觸發
    message = ImagemapSendMessage(
        base_url="https://images.pexels.com/photos/4524371/pexels-photo-4524371.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        ...
        actions=[
            URIImagemapAction(
                link_uri="https://www.google.com/?hl=zh_tw",
                area=ImagemapArea(
